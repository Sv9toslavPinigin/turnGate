...
data class TgStrings(
    ...
    val perApp: String,
    val perAppSub: String,
    val trafficRules: String,
    val trafficRulesSub: String,
    val tabRouteThrough: String,
    val tabBypass: String,
    val addRulePlaceholder: String,
    val addBtn: String,
    val presetsLabel: String,
    val presetRu: String,
    val presetGoogle: String,
    val presetLan: String,
    val addedPresetToast: String, // %s
    val noRulesYet: String,
    val ruleInvalid: String,
    val routeEverything: String,
    val routeEverythingSub: String,
    val routeWhitelist: String,
    val routeWhitelistSub: String,
    val routeBlacklist: String,
    val routeBlacklistSub: String,
    val routeSelectedCount: String, // %d
    val routeShowSystem: String,
    val routeSearchApps: String,
    val routeClearSelection: String,
    val routeSystemAppBadge: String,
...
private val EN = TgStrings(
    ...
    perAppSub = "Select which apps use the VPN",
    trafficRules = "Traffic rules",
    trafficRulesSub = "Route or bypass by IP, CIDR or domain",
    tabRouteThrough = "Route through VPN",
    tabBypass = "Bypass VPN",
    addRulePlaceholder = "1.2.3.0/24 or *.example.com",
    addBtn = "Add",
    presetsLabel = "Presets",
    presetRu = "RU services",
    presetGoogle = "Google",
    presetLan = "LAN",
    addedPresetToast = "Added preset: %s",
    noRulesYet = "No rules yet",
    ruleInvalid = "Invalid rule format",
    routeEverything = "Everything through VPN",
    routeEverythingSub = "Default — all apps route through the tunnel",
    routeWhitelist = "Only selected apps",
    routeWhitelistSub = "Whitelist — only checked apps use the VPN",
    routeBlacklist = "Exclude selected apps",
    routeBlacklistSub = "Blacklist — checked apps bypass the VPN",
    routeSelectedCount = "%d selected",
    routeShowSystem = "Show system apps",
    routeSearchApps = "Search apps…",
    routeClearSelection = "Clear selection",
    routeSystemAppBadge = "system",
...
private val RU = TgStrings(
    ...
    perAppSub = "Выберите, какие приложения используют VPN",
    trafficRules = "Правила трафика",
    trafficRulesSub = "Маршруты по IP, CIDR или домену",
    tabRouteThrough = "Через VPN",
    tabBypass = "Мимо VPN",
    addRulePlaceholder = "1.2.3.0/24 или *.example.com",
    addBtn = "Добавить",
    presetsLabel = "Шаблоны",
    presetRu = "Рос. сервисы",
    presetGoogle = "Google",
    presetLan = "LAN",
    addedPresetToast = "Добавлен шаблон: %s",
    noRulesYet = "Правил пока нет",
    ruleInvalid = "Неверный формат правила",
    routeEverything = "Всё через VPN",
    routeEverythingSub = "По умолчанию — весь трафик идёт через туннель",
    routeWhitelist = "Только выбранные приложения",
    routeWhitelistSub = "Только отмеченные приложения используют VPN",
    routeBlacklist = "Исключить выбранные приложения",
    routeBlacklistSub = "Отмеченные приложения идут в обход VPN",
    routeSelectedCount = "выбрано: %d",
    routeShowSystem = "Показать системные",
    routeSearchApps = "Поиск приложений…",
    routeClearSelection = "Сбросить выбор",
    routeSystemAppBadge = "системное",
